...
UmQuatroZeroTres:="|<1403>*180$27.80nXr0CqG83IEF0mWA87wEF02W38UKoLo2QSU"
...
NumpadAdd::
    if (ok:=FindText(X, Y, 407-150000, 222-150000, 407+150000, 222+150000, 0, 0, UmQuatroZeroTres)) {
        ...
        if ClickOnImage(Itens, 0, 0, "L", "Itens", X, Y){
            ...
            while(ItensV) {
                ...
                if ExistActivate("Impostos"){
                    ...
                    Sleep 32
                    Send, {Down}{Sleep 20}{Down}{Sleep 20}{Down}{Sleep 20}{Down}{Sleep 20}{Enter}
                    Sleep 32
